...
public class ModRecipes {
    ...
    public static void init(){
        ...
        GameRegistry.addSmelting(ModItems.LEAD_ORE_ROCK, new ItemStack(ModItems.LEAD_NUGGET), 1.0F);
        GameRegistry.addSmelting(ModItems.ZINC_ORE_ROCK, new ItemStack(ModItems.ZINC_NUGGET), 1.0F);
        GameRegistry.addSmelting(ModItems.TUNGSTEN_ORE_ROCK, new ItemStack(ModItems.TUNGSTEN_NUGGET), 1.0F);
